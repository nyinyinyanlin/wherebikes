...
app.get('/render',function(request,response,next){
  response.writeHead(301,
    {Location: "https://api.mapbox.com/styles/v1/nyinyinyanlin/cjaqik220hd4j2so1sm0rx8wi/static/96.166,16.825,11.4,0.00,0.00/1280x720@2x?access_token="+mapbox_key}
  );
  response.end();
});
